...
const Home = () => {
    ...
    const { data: products = [] } = useQuery({
        queryKey: ["products"],
        queryFn: async () => {
            const res = await fetch('https://luxsa-back-end.vercel.app/products');
    ...
    const { data: mens = [] } = useQuery({
        queryKey: ["mens"],
        queryFn: async () => {
            const res = await fetch('https://luxsa-back-end.vercel.app/category?category=Men');
            const data = await res.json();
            return data
        }
    });
    const { data: womens = [] } = useQuery({
        queryKey: ["womens"],
        queryFn: async () => {
            const res = await fetch('https://luxsa-back-end.vercel.app/category?category=Women');
            const data = await res.json();
            return data
        }
    });
    const { data: shoes = [] } = useQuery({
        queryKey: ["shoes"],
        queryFn: async () => {
            const res = await fetch('https://luxsa-back-end.vercel.app/category?category=Shoes');
            const data = await res.json();
            return data
        }
    });
    const { data: blogs = [] } = useQuery({
        queryKey: ["blogs"],
        queryFn: async () => {
            const res = await fetch('https://luxsa-back-end.vercel.app/blogs');
            const data = await res.json();
            return data;
        }
    });
    const sendMessage = (data) => {
        ...
        fetch('https://luxsa-back-end.vercel.app/message', {
            method: "POST",
            headers: {
