...
const AddProduct = () => {
    ...
    const handleAddProduct = (data) => {
        ...
        frontPhoto.append('upload_preset', 'jbyhfkv3');
        frontPhoto.append('cloud_name', 'dgiqqgdxn');
        fetch('https://api.cloudinary.com/v1_1/dgiqqgdxn/image/upload', {
            method: 'post',
            body: frontPhoto
        })
            .then(res => res.json())
            .then(frontData => {
                if (frontData.url) {
                    ...
                    backPhoto.append('upload_preset', 'jbyhfkv3');
                    backPhoto.append('cloud_name', 'dgiqqgdxn');
                    fetch('https://api.cloudinary.com/v1_1/dgiqqgdxn/image/upload', {
                        method: 'post',
                        body: backPhoto
                    })
                        ...
                        .then(data => {
                            if (data.url) {
                                ...
                                fetch('https://luxsa-back-end.vercel.app/add-product', {
                                    method: "POST",
                                    headers: {
