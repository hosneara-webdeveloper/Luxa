...
const CheckoutForm = ({ order, closeModal, i, refetch }) => {
    ...
    useEffect(() => {
        ...
        fetch("https://luxsa-back-end.vercel.app/create-payment-intent", {
            method: "POST",
    ...
    const handleSubmit = async (event) => {
        ...
        if (paymentIntent.status == 'succeeded') {
            ...
            fetch(`https://luxsa-back-end.vercel.app/paid/${order._id}`, {
                method: 'PUT',
                headers: {
                ...
                if (data.acknowledged || data.modifiedCount > 0) {
                    ...
                    fetch('https://luxsa-back-end.vercel.app/orders/paid', {
                        method: "POST",
                        headers: {
                            'content-type': 'application/json'
                        },
