...
const MyProducts = () => {
    ...
    const { data: products = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch(`https://luxsa-back-end.vercel.app/products/${user?.email}`);
    ...
    const handleUpdate = (id, e, i) => {
        ...
        fetch(`https://luxsa-back-end.vercel.app/product/${id}`, {
            method: "PATCH",
            headers: {
    ...
    const deleteTheProduct = (product) => {
        ...
        if (confirmDelete) {
            fetch(`https://luxsa-back-end.vercel.app/product/d/${product._id}`, {
                method: "DELETE"
            })
                .then(res => res.json())
                .then(data => {
